...
<div class="mt-5">
    <div class="new-about-wrapper" id="apply_now">
        <div class="row m-0 p-0">
            <form method="post" class="col-md-12" action="{{route('applynow.submit')}}" enctype="multipart/form-data">
                @csrf
                <?php
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fullname" name="fullname"
                                            ...
                                            placeholder="Ex : John" readonly required>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group custom-select">
                                        ...
                                        <select name="interest_country" id="interest_country" class="form-control"
                                            ...
                                            <option @if (isset($country) && !empty($country) &&
                                                $country==$countrywithcourse->country) selected @endif
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <label for="university">Choose University <span
                                                class="text-danger sign">*</span></label>
                                        <select name="university" id="university" style="width: 100% !important;"
                                            class="s-example-basic-single" disabled required>
                                            <option value="" selected="selected">Please Select</option>
                                            @foreach ($crm_universities as $universitys)
                                            <option @if (isset($university) && !empty($university) &&
                                                $university==$universitys->id) selected @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="intake" class="form-select" disabled required>
                                            <option @if ($intake_month=='Jan' ) selected @endif value="Jan">
                                                January</option>
                                            <option @if ($intake_month=='Feb' ) selected @endif value="Feb">
                                                February</option>
                                            <option @if ($intake_month=='March' ) selected @endif value="March">
                                                March</option>
                                            <option @if ($intake_month=='Apr' ) selected @endif value="Apr">
                                                April</option>
                                            <option @if ($intake_month=='May' ) selected @endif value="May">
                                                May</option>
                                            <option @if ($intake_month=='Jun' ) selected @endif value="Jun">
                                                June</option>
                                            <option @if ($intake_month=='Jul' ) selected @endif value="Jul">
                                                July</option>
                                            <option @if ($intake_month=='Aug' ) selected @endif value="Aug">
                                                August</option>
                                            <option @if ($intake_month=='Sept' ) selected @endif value="Sept">
                                                September</option>
                                            <option @if ($intake_month=='Oct' ) selected @endif value="Oct">
                                                October</option>
                                            <option @if ($intake_month=='Nov' ) selected @endif value="Nov">
                                                November</option>
                                            <option @if ($intake_month=='Dec' ) selected @endif value="Dec">
                                                December</option>
                                        </select>
                                        <input type="hidden" name="intake" value="{{ $intake_month }}">
                                        @else
                                        <select name="intake" id="intake" class="form-select" @if (!isset($university)
                                            && empty($university)) disabled @endif required>
                                            <option value="" selected="selected">Please Select</option>
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group custom-select">
                                        ...
                                        <label for="int_course_level">Interested Course <span
                                                class="text-danger sign">*</span></label>
                                        @if (isset($course) && !empty($course))
                                        <select name="int_course_level" class="s-example-basic-single"
                                            style="width: 100% !important;" disabled required>
                                            <option value="{{ $courses->id }}" selected="selected"
                                                class="gf_placeholder">{{ $courses->title }}</option>
                                        </select>
                                        <input type="hidden" name="int_course_level" value="{{ $courses->id }}">
                                        @else
                                        <select name="int_course_level" id="course" class="s-example-basic-single"
                                            style="width: 100% !important;" disabled required>
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group custom-select">
                                        <label for="passed_year">Passed Year <span
                                                class="text-danger sign">*</span></label>
                                        <select name="passed_year" id="passed_year" class="form-select" required>
                        ...
                        <div class="card shadow p-4">
                            <div class="new-form-wrapper px-3">
                                ...
                                <div class="row p-0 m-0">
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            <label for="grade">Grade 12 Certificate</label><span
                                                class="text-danger sign">*</span></label>
                                ...
                                <div class="form-group consent" style="align-items:center;">
                                    <div class="col-md-12">
                                        <div class="flex pb-10">
                                            <input type="checkbox" class="me-2" name="confirm" id="confirm" value="Yes"
                                                required>
                                            <label for="confirm">Your Consent</label>
                                        </div>
...
<script>
    $(document).ready(function() {
            ...
            $('#university,#intake').change(function(){
                filterCourses();
            });
        });
</script>
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 200) {
                            ...
                            $.each(response.courses, function(key, item) {
                                //console.log(item);
                                $('#course').append('<option value="' + item.id
                                + '">' + item
                                    .course + '</option>');
                            });
                        } else {
