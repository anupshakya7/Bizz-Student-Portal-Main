            ...
            <div class="card p-4 mt-3 shadow">
                ...
                <div>
                    <div class="search my-1">
                        ...
                        <input type="range" class="form-range" name="fees" min="0" max="200000" step="500"
                            value="0" id="fees" disabled>
                    </div>
                    <div class="search my-1">
                        <label for="duration" class="form-label">Scholarships (0 to <span
                                id="scholarships_range"></span>)</label>
                        <input type="range" class="form-range" name="scholarship" min="0" max="5000"
                            step="100" value="0" id="scholarship" disabled>
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#country,#level,#stream,#intake,#university,#courses,#fees,#scholarship').on('change', function(e) {
                e.preventDefault();
                search();
            });
        ...
        function events(page) {
            ...
            let url = '';
            let search = '';
            if (country != "" || level != "" || stream != "" || intake != "" || university != "" || courses != "" || fees != "" || scholarship != "") {
                if (country != "") {
                    if (search == "") {
