...
@section('style')
    <style>
        .wrapper {
            ...
            border-radius: 10px;
            padding: 20px;
            box-shadow: 4px 12px 35px rgba(0, 0, 0, 0.1);
            margin: 5px;
        }
                ...
                <div>
                    <div class="wrapper">
                        ...
                        <div class="price-input">
                            <div class="field">
                                <span>Min</span>
                                <input type="number" class="input-min" value="2500" disabled>
                            </div>
                            <div class="separator">-</div>
                            <div class="field">
                                <span>Max</span>
                                <input type="number" class="input-max" value="7500" disabled>
                            </div>
                        </div>
                        <div class="slider">
                        ...
                        <div class="range-input">
                            <input type="range" class="range-min" min="0" max="100000" name="min_fees" id="min_fees" value="2500" step="100" disabled>
                            <input type="range" class="range-max" min="0" max="100000" name="max_fees" id="max_fees" value="7500" step="100" disabled>
                        </div>
                    </div>
...
@section('script')
    <script>
        ...
        function search() {
            ...
            let university = $('#university').val();
            let courses = $('#courses').val();
            let minfees = $('#min_fees').val();
            let maxfees = $('#max_fees').val();
            // let scholarship = $('#scholarship').val();
