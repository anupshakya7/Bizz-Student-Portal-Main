...
class CourseSearchController extends Controller
{
    ...
    public function searchUniversity(Request $request){
		...
		if(isset($request->degree) && !empty($request->degree)){
			$where .= ' AND courses.level="'.$request->degree.'"';
		}
		...
		if(!empty($request->courses) || !empty($request->university)){
			return view('university_search.course_university_search',compact('search','result_count'))->render();
		}else{
			return view('university_search.other_search',compact('search','result_count'))->render();
		}
